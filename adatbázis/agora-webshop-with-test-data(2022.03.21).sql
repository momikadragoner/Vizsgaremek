...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `beginSession` (IN `mail` VARCHAR(320), IN `token` VARCHAR(600))  NO SQL
BEGIN
...
CREATE TABLE `session` (
  ...
  `member_id` int(11) NOT NULL,
  `jwt` varchar(600) COLLATE utf8mb4_hungarian_ci NOT NULL,
...
(13, 26, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Zpw3flNBi4c7oqOwZ7pdU0WBzf8QqcwEvfzwYkowOqE', '2022-03-21 20:46:49');
...
--
ALTER TABLE `cart_product`
  MODIFY `cart_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `review_vote`
  MODIFY `review_vote_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
