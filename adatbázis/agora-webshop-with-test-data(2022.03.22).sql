...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2022 at 11:22 PM
...
(33, 26, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..K12iAQDN188KKEBcEthHVdx6Z7B_EqYw-2_1fJGdc0Y', '2022-03-22 21:24:44'),
...
(39, 21, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Tiz03PNsnK9PifrmM6ECra-QveRZknEMl0qScXm-vAo', '2022-03-22 21:49:06');
...
--
ALTER TABLE `cart_product`
  MODIFY `cart_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `product_material`
  MODIFY `product_material_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `product_picture`
--
ALTER TABLE `product_picture`
  MODIFY `product_picture_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `product_tag`
--
ALTER TABLE `product_tag`
  MODIFY `product_tag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
